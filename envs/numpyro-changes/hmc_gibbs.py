...
class HMCGibbs(MCMCKernel):
    ...
    **Example**
    ...
    def __init__(self, inner_kernel, gibbs_fn, gibbs_sites, init_strategy=init_to_sample): #TODO
        ...
        self._init_strategy = init_strategy #TODO
    ...
    def init(self, rng_key, num_warmup, init_params, model_args, model_kwargs):
        ...
        if self._prototype_trace is None:
            ...
            self._prototype_trace = trace(
                substitute(seed(self.model, key_u), substitute_fn=self._init_strategy) #TODO
...
class DiscreteHMCGibbs(HMCGibbs):
    ...
    **Example**
    ...
    def __init__(self, inner_kernel, *, random_walk=False, modified=False, init_strategy=init_to_sample): #TODO
